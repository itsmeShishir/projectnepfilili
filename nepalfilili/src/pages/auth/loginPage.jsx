          ...
          <form action='POST' className='col-md-6 right-box'>
            <div className='row align-items-center'>
              ...
              <div className='input-group mb-3'> 
                <input type="email" className='form-control form-control-lg bg-light fs-6' placeholder='Enter your Email' onChange={handleChange} value={data.username} required />
              </div>

              <div className='input-group mb-1'> 
                <input type="password" className='form-control form-control-lg bg-light fs-6' placeholder='Enter your Password' onChange={handleChange} value={data.password} required />
              </div>
...
<<<<<<< HEAD
              ...
              <div className='input-group mt-3 mb-2'>
                <button className='btn btn-lg btn-light w-100 fs-6'><img src={googlelogo} style={{width: "30px"}} alt=""  className='me-2'/>Sign in with Google</button>
              </div>
              <div className='row mb-2 fs-6'>
                <small>Don't have an account? <Link to="/auth/register" className='mx-2 justify-content-center'>Sign-Up</Link></small>
              </div>
            </div>
